...
$query2 = mysqli_query($conn, "SELECT * FROM orders WHERE custID='$id_user'");
?>
...
<body>
    ...
    <div class="container">
        <h4 class="text-center fw-bold">MY ORDER</h4>
        <a href="addorder.php" class="btn btn-success">Add Order</a>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody class="table-group-divider">
                <?php while($order = mysqli_fetch_assoc($query2)){?>
                <tr>
